...
function wpdocs_codex_Jobs_init() {
    $labels = array(
        ...
        'menu_name'             => _x( 'Jobs Feed', 'Admin Menu text', 'textdomain' ),
        ...
        'archives'              => _x( 'Jobs archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'textdomain' ),
